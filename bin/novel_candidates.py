...
def main():
    ...
    if os.path.getsize(genomad) > 0:
        ...
        #first_col = genomad_results.columns[0]
        #genomad_results.drop(['sample_name'], axis=1, inplace=True)
